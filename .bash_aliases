...
alias venv39='virtualenv .venv --python python3.9 && a'
alias venv310='virtualenv .venv --python python3.10 && a'
alias venv311='virtualenv .venv --python python3.10 && a'
...
# Development
#
alias devenv='tox --devenv .venv && a'
